...
describe "Viewing the list of movies" do
  ...
  it "shows the movies" do
    ...
    expect(page).to have_text(movie2.description[0..10])
    expect(page).to have_text(movie3.description[0..10])
    expect(page).to have_text(movie1.released_on.year)
    expect(page).to have_text(movie2.released_on.year)
    expect(page).to have_text(movie3.released_on.year)
