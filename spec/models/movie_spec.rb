...
describe "A movie" do
  it "is a flop if the total gross is less than $50.00M" do
  ...
  it "requires a description over 20 characters" do
    movie = Movie.new(description: "x" * 20)
    movie.valid?
  ...
  it "it accepts a positive total gross" do
  ...
  it "it rejects a negative total gross" do
    movie = Movie.new(total_gross: -1000000.00)
    movie.valid?
  ...
  it "accepts properly formatted image file name" do
  ...
  it "rejects improperly formatted image file name" do
  ...
  it "has fans" do
    movie = Movie.new(movie_attributes)
    fan1 = User.new(user_attributes(email: "subrat@example.com"))
    fan2 = User.new(user_attributes(email: "daniel@example.com"))
